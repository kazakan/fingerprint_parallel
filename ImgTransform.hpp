...
class ImgTransform {
  private:
    ...
    /**
     * @brief  One interation behavior of rosenfield 4 connected thinnining algorithm.
    ...
    /**
     * @brief  One interation behavior of rosenfield 8 connected thinnining algorithm.
     * @param src Input buffer
     * @param dst Output buffer
     * @param dir Border direction to calculate. (N,E,S,W) = (0,1,2,3)
     * @return Whether none of any pixel changed.
  ...
  public:
    ...
    /**
     * @brief Dynamic thresholding method. If pixel > avg(block pixels) then 255 else 0;
     * @param src Original image.
